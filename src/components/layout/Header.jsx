...
const products = [
  ...
  { name: 'PALESTRA-2', description: 'Full Scale Prototype', href: '#', icon: CursorArrowRaysIcon },
                ...
                {products.map((item) => (
                  ...
                  >
                    <div className="flex size-11 flex-none items-center justify-center rounded-lg bg-gray-700/50 group-hover:bg-gray-700">
                      <item.icon aria-hidden="true" className="size-6 text-white-400 group-hover:text-white" />
                    </div>
