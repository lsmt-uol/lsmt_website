...
export default function Aboutus() {
    ...
    return (
        <section className="w-full bg-gradient-to-t from-gray-900 via-black to-gray-900 h-fit py-3 flex flex-wrap md:flex-row-reverse flex-col md:items-stretch"> 
            <div className="md:w-1/2 w-full h-full ">
                <img
                    src={aboutImage}
                    alt="Leeds Sustainable Marine Team"
                    className="w-full h-auto object-cover md:h-full rounded-[5px]" 
                />
            </div>
