...
const App = () => {
    ...
    const contactDetails = [
        ...
        { 
            Icon: Mail, 
            text: 'awesome@company.com', 
            id: 'email',
            href: 'mailto:awesome@company.com' 
        },
        { 
            Icon: MapPin, 
            text: (
                <>
                    663 New Walk Roadside, Birdeye View, GO <br className="hidden sm:inline" /> 11020
                </>
            ), 
            id: 'location',
            align: 'start',
                    ...
                    <div className="space-y-12 lg:border-l lg:border-gray-700 lg:pl-12 pt-8 lg:pt-0">
                        ...
                        <div className="border-t border-gray-700 pt-8">
                            ...
                            <div className="space-y-4">
                                {socialLinks.map(({ Icon, label, colorClass, id, href }) => (
                                    <a 
                                        key={id} 
                                        href={href} 
                                        className={`flex items-center gap-3 transition duration-150 text-white ${colorClass} focus:outline-none focus:ring-2 focus:ring-sky-500`} 
                                        aria-label={label}
                                    >
